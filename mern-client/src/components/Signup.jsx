			...
			<div class="max-w-md mx-auto">
				...
				<div class="divide-y divide-gray-200">
					<form onSubmit={handleSignUp} class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <p>If you have an account. Please<Link to="/login" className='text-pink-700 underline'>   Login</Link></p>
						<div class="relative">
							<button class="bg-pink-500 text-white rounded-md px-6 py-2">Sign Up</button>
						</div>
					</form>
				</div>
